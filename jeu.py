...
while running:
    for event in pygame.event.get():
        ...
        if depl[2] != -1:
            ...
            if piece == "P":
                chessboard.deplacement_pion(x, y, new_x, ney_y)

            if piece == "T":
                chessboard.deplacement_tour(x, y, new_x, ney_y)

            if piece == "C":
                chessboard.deplacement_cavalier(x, y, new_x, ney_y)

            if piece == "F":
                chessboard.deplacement_fou(x, y, new_x, ney_y)

            if piece == "R":
                chessboard.deplacement_roi(x, y, new_x, ney_y)

            if piece == "D":
                chessboard.deplacement_dame(x, y, new_x, ney_y)

        chessboard.print_board(screen)
